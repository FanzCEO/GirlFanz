...
const BreadcrumbSeparator = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ role: "presentation", "aria-hidden": "true", className: (0, utils_1.cn)("[&>svg]:w-3.5 [&>svg]:h-3.5", className) }, props), children !== null && children !== void 0 ? children : React.createElement(lucide_react_1.ChevronRight, null)));
};
